			 ...
			 <div class="col-lg-4 col-sm-6 mb-4">
                <div class="portfolio-item">
                    <a class="portfolio-link" data-toggle="modal" href="#portfolioModal6">
                        ...
                        <img class="img-fluid" src="assets/img/portfolio/nueva.nuevita.jpg" alt=""/>
                    </a>
                    <div class="portfolio-caption">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="modal-body">
                            ...
                            <p>Envianos un mensaje al número: 970523305</p>
                            <ul class="list-inline">
                                <li>Tallas 34 - 40</li>
                                <li>Precio Especial: S/.30</li>
                            </ul>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="modal-body">
                            ...
                            <p class="item-intro text-muted">Seguridad y Confort.</p>
                            <img class="img-fluid d-block mx-auto"
                                 src="assets/img/portfolio/nueva.nuevita.jpg" alt=""/>
                            <p>Envianos un mensaje al número: 970523305/999614206</p>
                            <ul class="list-inline">
                                <li>Tallas 38 - 44</li>
                                <li>Precio Especial: S/.35</li>
                            </ul>
